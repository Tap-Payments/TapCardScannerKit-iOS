...
internal final class CardBINRange {
    ...
    private static let allRanges = [
        ...
        CardBINRange(lowRange: "50"    , highRange: "50"    , lengths: [12, 13, 14, 15, 16, 17, 18, 19], brand: .masterCard),
        CardBINRange(lowRange: "56"    , highRange: "64"    , lengths: [12, 13, 14, 15, 16, 17, 18, 19], brand: .masterCard),
        CardBINRange(lowRange: "66"    , highRange: "69"    , lengths: [12, 13, 14, 15, 16, 17, 18, 19], brand: .masterCard),
