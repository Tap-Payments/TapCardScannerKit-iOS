#
#  Be sure to run `pod spec lint TapCardScanner-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Tap Payments" => "o.rabie@tap.company" }
  # Or just: spec.author    = "Tap Payments"
  # spec.authors            = { "Tap Payments" => "o.rabie@tap.company" }
  # spec.social_media_url   = "https://twitter.com/Tap Payments"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapCardScannerKit-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapCardScanner-iOS/Core/**/*.{h,m,swift}"
